...
//Render todo items from lowDB with edit toggle and remove icons
    function renderFeed(todoItems) {
        ...
        for (const todoItem of todoItems) {
            ...
            tr.innerHTML += `<td><button type="button" rel="tooltip" title="Remove" class="fa fa-trash js-todo-remove">
            ...
            tr.querySelector('.js-todo-edit').addEventListener('click', (e) => {
              ...
              <input type="text" class="form-control js-update-title" placeholder="title" aria-describedby="basic-addon1" value="${todoItem.data.title}">
              <input type="text" class="form-control js-update-text" placeholder="body" aria-describedby="basic-addon1" value="${todoItem.data.todo}">
              </div>
